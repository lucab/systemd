...
struct ExecContext {
        ...
        char *std_input_fdname;
        char *std_output_fdname;
        char *std_error_fdname;
...
int exec_context_named_iofds(Unit *unit, const ExecContext *c, const ExecParameters *params, int *named_iofds);
