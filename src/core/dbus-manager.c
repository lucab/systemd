...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        SD_BUS_PROPERTY("DefaultStandardOutput", "s", NULL, offsetof(Manager, default_std_output), SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("DefaultStandardError", "s", NULL, offsetof(Manager, default_std_output), SD_BUS_VTABLE_PROPERTY_CONST),
